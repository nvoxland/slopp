(ns slopp.ui.markdown-test
  "What [[slopp.ui.markdown]] promises about real docstrings.
  ...
  (:require [clojure.test :refer [deftest testing is]]
            [slopp.ui.markdown :as markdown]))

(deftest a-docstring-keeps-the-structure-its-author-wrote
  ;; The instance: `/p/slopp.ui/endpoints/get/api/projects` rendered a
