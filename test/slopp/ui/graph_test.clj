...
(deftest no-edge-passes-through-a-box-on-this-project-s-own-manifest
  ...
  (let [pic (graph/picture-of
             {:modules [{:module "slopp.ui.basepath"  :foundation true  :deps []}
                        {:module "slopp.ui.client"    :foundation false
                         :deps ["slopp.ui.graph" "slopp.ui.spa" "slopp.ui.views"]}
                        {:module "slopp.ui.contracts" :foundation false :deps []}
                        {:module "slopp.ui.graph"     :foundation false :deps []}
                        {:module "slopp.ui.hub"       :foundation false
                         :deps ["slopp.ui.contracts" "slopp.ui.registry" "slopp.ui.views"]}
                        {:module "slopp.ui.nav"       :foundation false :deps []}
                        {:module "slopp.ui.nsfilter"  :foundation false :deps []}
                        {:module "slopp.ui.registry"  :foundation false :deps []}
                        {:module "slopp.ui.spa"       :foundation false :deps ["slopp.ui.nav"]}
                        {:module "slopp.ui.styles"    :foundation false :deps []}
                        {:module "slopp.ui.views"     :foundation false
                         :deps ["slopp.ui.nav" "slopp.ui.nsfilter"]}]
              :layers [["slopp.ui.contracts" "slopp.ui.graph" "slopp.ui.nav"
                        "slopp.ui.nsfilter" "slopp.ui.registry" "slopp.ui.styles"]
                       ["slopp.ui.spa" "slopp.ui.views"]
                       ["slopp.ui.client" "slopp.ui.hub"]]})
...
(testing "and no fan crosses itself: hub's three edges leave in the order
    ...
    (testing "and ordering leaves nothing crossing either, once the skips are
      ...
      (let [manifest {"slopp.ui.client" ["slopp.ui.graph" "slopp.ui.spa" "slopp.ui.views"]
                      "slopp.ui.hub"    ["slopp.ui.contracts" "slopp.ui.registry" "slopp.ui.views"]
                      "slopp.ui.spa"    ["slopp.ui.nav"]
                      "slopp.ui.views"  ["slopp.ui.nav" "slopp.ui.nsfilter"]
                      "slopp.ui.contracts" [] "slopp.ui.graph" [] "slopp.ui.nav" []
                      "slopp.ui.nsfilter" [] "slopp.ui.registry" [] "slopp.ui.styles" []}
            layers   [["slopp.ui.contracts" "slopp.ui.graph" "slopp.ui.nav"
                       "slopp.ui.nsfilter" "slopp.ui.registry" "slopp.ui.styles"]
                      ["slopp.ui.spa" "slopp.ui.views"]
...
(deftest a-fan-leaves-in-the-ORDER-ITS-TARGETS-SIT-not-in-name-order
  ;; slopp.ui.hub depends on contracts, registry and views. The fan handed out
