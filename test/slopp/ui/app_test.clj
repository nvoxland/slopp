(ns slopp.ui.app-test
  ...
  **What it replaces:** a Playwright harness pointing at an absolute path into
  ...
  (:require [clojure.test :refer [deftest testing is]]
            ...
            [slopp.ui.app :as app]
            [slopp.ui.views :as views] [slopp.cljnx :as cljnx] [slopp.ui.page :as page] [slopp.webapp :as webapp] [slopp.ui.schema :as schema] [slopp.http.endpoint :as endpoint] [slopp.ui.wire.api :as api]))
...
(deftest the-declaration-this-app-hands-both-entries-is-a-valid-one
  ...
  ;; `slopp.ui.client.app` is `:cljs` and never loads into the image, so
...
(deftest the-arming-gate-reads-the-METHOD-because-nobody-publishes-effectful
  ...
  ;;
  ;; `slopp.ui.schema-test` had already recorded the near-miss: *":auth landed
